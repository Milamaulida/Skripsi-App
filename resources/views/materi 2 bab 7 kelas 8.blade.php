...
<div class="container mx-auto p-4">
    ...
    <center><div style="position: relative; color: black; font-size: 32px; font-family: Poppins; font-weight: 400; word-wrap: break-word">Mengkaji Informasi Media Sosial</div></center>
    <div>
    ...
    <a href="/materi 1 bab 7 kelas 8" class="btn-materi">
        ← Materi Sebelumnya
    </a>
    <a href="/materi 3 bab 7 kelas 8" class="btn-materi">
        Materi Selanjutnya →
    </a>
    </div>
