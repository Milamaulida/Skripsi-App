...
<div class="container mx-auto p-4">
    <a href="/bab semester 1 kelas 9" class="text-gray-600 flex items-center mb-4">
        &larr; Daftar Bab
    </a>
    <br>
    ...
    <center><div style="position: relative; color: black; font-size: 32px; font-family: Poppins; font-weight: 400; word-wrap: break-word">Blog</div></center>
    <div>
    ...
    <a href="/materi 1 bab 2 kelas 9" class="btn-materi">
        ← Materi Sebelumnya
    </a>
    <a href="/materi 3 bab 2 kelas 9" class="btn-materi">
        Materi Selanjutnya →
    </a>
    </div>
