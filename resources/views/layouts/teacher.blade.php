    ...
    <div>
        <aside class="fixed top-0 left-0 w-64 bg-white shadow-md h-screen p-3 z-50">
            ...
            <nav class="mt-5">
                <ul>
                    <li class="mb-2">
                        <a href="{{ route('guru.dashboard') }}" class="flex items-center p-3 rounded hover:bg-gray-200">
                    ...
                    <li class="mb-2">
                        <a href="{{ route('exam.select-class') }}"
                    ...
                    <li class="mb-2">
                        <a href="about-us-teacher" class="flex items-center p-3 rounded hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2d2d2d"
                                viewBox="0 0 24 24">
                                <path
