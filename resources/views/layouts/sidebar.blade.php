    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white shadow-md min-h-screen p-5">
            ...
            <nav class="mt-5">
                <ul>
                    <li class="mb-2">
                        <a href="/dashboard student" class="flex items-center p-3 rounded hover:bg-gray-200">
                    ...
                    <li class="mb-2">
                        <a href="/class student" class="flex items-center p-3 rounded hover:bg-gray-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2d2d2d" viewBox="0 0 24 24">
                    ...
                    <li class="mb-2">
                        <a href="/nilai student" class="flex items-center p-3 rounded hover:bg-gray-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2d2d2d" viewBox="0 0 24 24">
                    ...
                    <li class="mb-2">
                        <a href="tentang kami" class="flex items-center p-3 rounded hover:bg-gray-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2d2d2d" viewBox="0 0 24 24">
                    ...
                    <li class="mb-2">
                        <a href="/login" class="flex items-center p-3 rounded hover:bg-gray-200 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2d2d2d" viewBox="0 0 24 24">
