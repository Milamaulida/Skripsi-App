...
<div class="flex justify-between items-center mb-8">
    ...
    <img src="{{ asset('images/pic1.png') }}" alt="Ilustrasi">
        <div>
        <div style="width: 345px; height: 38px; color: white; font-size: 24px; font-family: Poppins; font-weight: 700; word-wrap: break-word">SELAMAT DATANG, BU MILA</div>
        <div style="width: 460.06px; height: 63.17px; color: white; font-size: 40px; font-family: Poppins; font-weight: 700; word-wrap: break-word">AYO MULAI MENGAJAR</div>
        </div>
    </div>
