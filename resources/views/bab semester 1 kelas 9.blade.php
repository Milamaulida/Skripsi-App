...
<div class="container mx-auto p-4">
    ...
    <div class="flex flex-col gap-4">
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
            ...
            <a href="/materi 1 bab 1 kelas 9" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Pelajari
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/materi 1 bab 2 kelas 9" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Pelajari
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/materi 1 bab 3 kelas 9" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Pelajari
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/materi 1 bab 4 kelas 9" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Pelajari
            </a>
        </div>
    </div>
