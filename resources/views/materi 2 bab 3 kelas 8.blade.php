...
<div class="container mx-auto p-4">
    <a href="/bab semester 1 kelas 8" class="text-gray-600 flex items-center mb-4">
        &larr; Daftar Bab
    </a>
    <br>
    ...
    <center><div style="position: relative; color: black; font-size: 32px; font-family: Poppins; font-weight: 400; word-wrap: break-word">Pengalamatan Memori dan Central Processing Unit</div></center>
    <div>
    ...
    <a href="/materi 1 bab 3 kelas 8" class="btn-materi">
        ← Materi Sebelumnya
    </a>
    </div>
