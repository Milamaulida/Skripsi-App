  ...
  <div class="flex gap-3 mb-4">
        @for ($i = 1; $i <= 6; $i++)
            <div class="w-8 h-8 flex items-center justify-center rounded-full text-sm font-semibold
                {{ $i == 4 ? 'bg-yellow-400 text-white' : 'bg-gray-200 text-gray-600' }}">
                {{ $i }}
            </div>
        @endfor
    </div>
...
></textarea>
    ...
    <div class="flex justify-end gap-3 mt-6">
        ...
        <a href="/soal 5 ph2 kelas 7"><button class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-md">
            NEXT
        </button></a>
    </div>
</div>
