...
<div class="container mx-auto p-4">
    ...
    <br>
    <center><div style="position: relative; color: black; font-size: 32px; font-family: Poppins; font-weight: 400; word-wrap: break-word">MATERI 5</div></center>
    <center><div style="position: relative; color: black; font-size: 32px; font-family: Poppins; font-weight: 400; word-wrap: break-word">Aplikasi Perkantoran</div></center>
    <div>
    ...
    <a href="/materi 4 bab 2 kelas 7" class="btn-materi">
        ← Materi Sebelumnya
    </a>
    </div>
