...
<div class="container mx-auto p-4">
    ...
    <center><div style="position: relative; color: black; font-size: 32px; font-family: Poppins; font-weight: 400; word-wrap: break-word">Robot Manual</div></center>
    <div>
    ...
    <a href="/materi 2 bab 6 kelas 7" class="btn-materi">
        ← Materi Sebelumnya
    </a>
    </div>
</div>
