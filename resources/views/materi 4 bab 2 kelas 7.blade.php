...
<div class="container mx-auto p-4">
    ...
    <center><div style="position: relative; color: black; font-size: 32px; font-family: Poppins; font-weight: 400; word-wrap: break-word">Surel</div></center>
    <div>
    ...
    <a href="/materi 5 bab 2 kelas 7" class="btn-materi">
        Materi Selanjutnya →
    </a>
    </div>
