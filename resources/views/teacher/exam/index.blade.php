...
<div class="flex-1 bg-gray-50 px-8 py-6">
    ...
    <div class="mt-6 grid grid-cols-2 gap-4">
        ...
        <div class="bg-gray-100 p-4 rounded-lg">
            <center>
                <div
                    style="width: 117px; height: 22px; color: #3C3C3C; font-size: 14px; font-family: Poppins; font-weight: 600; word-wrap: break-word">
                    Riwayat Belajar</div>
            </center>
            <br>
            <div class="flex items-center space-x-4">
                ...
                <div class="text-content">
                    <div
                        style="width: 100%; height: 100%; position: relative; color: #007DBA; font-size: 13px; font-family: Poppins; font-weight: 600; word-wrap: break-word">
                        MATERI BAB 1 KELAS 7</div>
                    <div
                        style="width: 100%; height: 100%; position: relative; color: #FED600; font-size: 15px; font-family: Poppins; font-weight: 600; word-wrap: break-word">
                        MATERI 2</div>
                    <div
                        style="width: 100%; height: 100%; position: relative; text-align: justify; justify-content: center; display: flex; flex-direction: column; color: #3C3C3C; font-size: 15px; font-family: Poppins; font-weight: 500; word-wrap: break-word">
                        Morbi ipsum ipsum, congue a aliquam sit amet, faucibus vel tortor. Maecenas non porta enim.
                        Nullam bibendum sapien est.</div>
                    <a href=""><button
                            class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-2 rounded-lg right-10">
                            Lanjut Pelajari
                        </button></a>
                </div>
            </div>
