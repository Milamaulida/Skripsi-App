...
@section('content')
    <div class="bg-gray-50 min-h-screen px-6 pt-6 pb-10 font-poppins">
        ...
        <!-- Welcome Banner -->
        <div
            class="bg-blue-500 rounded-xl text-white p-6 flex flex-col-reverse md:flex-row items-center justify-between shadow-md mb-10">
            <div class="space-y-2 md:text-left text-center">
                <h2 class="text-xl md:text-2xl font-semibold">SELAMAT DATANG, BU MILA</h2>
                <h1 class="text-3xl md:text-4xl font-bold">Ayo Mulai Mengajar!!</h1>
            </div>
        ...
        <div class="max-w-6xl mx-auto mb-10 bg-white rounded-xl shadow-lg flex flex-col md:flex-row overflow-hidden">
            ...
            <div class="md:w-1/2 p-8 text-gray-800 text-justify flex flex-col justify-center">
                ...
                <p class="mb-6 text-base  leading-relaxed">
                    Mengembangkan dan meningkatkan pondasi anak didik agar memiliki life skill, kreatif, berkualitas, serta
