...
<div class="container mx-auto p-4">
    <a href="/semester kelas 9" class="text-gray-600 flex items-center mb-4">
        &larr; Kembali
    </a>
    <div class="flex flex-col gap-4">
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
            ...
            <a href="/materi 1 bab 5 kelas 9" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Pelajari
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/materi 1 bab 6 kelas 9" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Pelajari
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/materi 1 bab 7 kelas 9" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Pelajari
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/materi 1 bab 8 kelas 9" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Pelajari
            </a>
        </div>
    </div>
