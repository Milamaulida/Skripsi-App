...
<div class="container mx-auto p-4">
    ...
    <div class="flex flex-col gap-4">
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
            ...
            <a href="/edit materi bab 1 kelas 8 semester 1 guru" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Edit Materi
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/edit materi bab 2 kelas 8 semester 1 guru" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Edit Materi
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/edit materi bab 3 kelas 8 semester 1 guru" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Edit Materi
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/edit materi bab 4 kelas 8 semester 1 guru" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
                Edit Materi
            </a>
        </div>
    </div>
