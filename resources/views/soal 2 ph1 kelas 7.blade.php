...
<div class="search-container">
    ...
    <a href="/soal 1 ph1 kelas 7"><button class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-md">
            PREV
        </button></a>    
        
        <a href="/soal 3 ph1 kelas 7"><button class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-md">
            NEXT
        </button></a>
    </div>
</div>
