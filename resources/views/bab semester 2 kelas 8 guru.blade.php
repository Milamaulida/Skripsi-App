...
<div class="container mx-auto p-4">
    <a href="/semester kelas 8 guru" class="text-gray-600 flex items-center mb-4">
        &larr; Kembali
    </a>
    <div class="flex flex-col gap-4">
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
            ...
            <a href="/edit materi bab 5 kelas 8 semester 2 guru" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
            Edit Materi
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/edit materi bab 6 kelas 8 semester 2 guru" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
            Edit Materi
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/edit materi bab 7 kelas 8 semester 2 guru" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
            Edit Materi
            </a>
        </div>
        <div class="bg-white shadow-lg rounded-lg p-4 flex items-center">
        ...
        <div class="flex-1">
            ...
            <a href="/edit materi bab 8 kelas 8 semester 2 guru" class="bg-blue-500 text-white px-4 py-2 rounded-lg">
               Edit Materi
            </a>
        </div>
    </div>
